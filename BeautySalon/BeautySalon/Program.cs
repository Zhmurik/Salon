...
namespace BeautySalon
{
    class Program
    {
        ...
        static void CutHair()
        {
            ...
            Console.WriteLine("Так же можем предложить другие услуги: 1-помыть голову за $7 + Подстричь зв $30, либо сет 2 - помыть голову+укладка+стрижка за $57, 3 - только стрижка - $30");
        ...
        static void StyleHair()
        {
            ...
            Console.WriteLine("Так же можем предложить другие услуги: 1-помыть голову за $7,  2 - только стрижка - $30");
            Console.WriteLine("Если хотите что-то добавить из перечисленного, нажмите нужную цифру, если нет нажмите 0");
            int set = Convert.ToInt32(Console.ReadLine());
            if (set == 1)
            {
